...
export const env = {
  ...
  RAZORPAY_MODE: process.env.RAZORPAY_KEY_ID && process.env.RAZORPAY_KEY_SECRET ? 'CONFIGURED' : 'NOT_CONFIGURED',
  SMS_PROVIDER_MODE: process.env.SMS_API_KEY || process.env.SMS_PROVIDER_KEY || process.env.MSG91_AUTH_KEY || process.env.TWILIO_ACCOUNT_SID ? 'CONFIGURED' : 'NOT_CONFIGURED',
  WHATSAPP_PROVIDER_MODE: process.env.WHATSAPP_API_TOKEN ? 'CONFIGURED' : 'NOT_CONFIGURED',
  IVR_PROVIDER_MODE: process.env.IVR_API_KEY ? 'CONFIGURED' : 'NOT_CONFIGURED',
  PUSH_PROVIDER_MODE: process.env.FCM_SERVER_KEY ? 'CONFIGURED' : 'NOT_CONFIGURED',
  PAYOUT_PROVIDER_MODE: process.env.PAYOUT_API_KEY ? 'CONFIGURED' : 'NOT_CONFIGURED',
  KYC_PROVIDER_MODE: process.env.KYC_PROVIDER_KEY ? 'CONFIGURED' : 'NOT_CONFIGURED',
